...
const ServiceComplaintRejected = () => {
  ...
  const getComplaintRejected = (params: any) => new Promise((resolve: any, reject: any) => {
    Api.get(`${urlService}/complaint-rejected`, {
  ...
  return {
    getComplaintRejected,
  };
};

export default ServiceComplaintRejected;
