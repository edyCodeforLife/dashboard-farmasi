...
import ServiceOrderRefund from '@services/api/ServiceOrderRefund';
...
const Service = () => {
  ...
  const { getOrderRefund } = ServiceOrderRefund();
  const fileLocation = 'components/pages/order-refund/Service.tsx';
  ...
  const getListOrder = async () => {
    try {
      ...
      const result: any = await getOrderRefund(params);
  ...
  useEffect(() => SetStorage('currentUrl', '/order-refund'), []);
